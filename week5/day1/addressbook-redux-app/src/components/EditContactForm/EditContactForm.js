...
export default function EditContactForm({ match: { params }, history }) {
    const contactIn = useSelector((state) => state.singleContactReducer);
    ...
    const handleSubmit = async (evt) => {
        evt.preventDefault();
        dispatch(await updateContact({ ...contact }));
