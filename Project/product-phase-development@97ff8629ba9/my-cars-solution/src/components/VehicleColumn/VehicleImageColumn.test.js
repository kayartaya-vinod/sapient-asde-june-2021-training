...
import VehicleImageColumn from "./VehicleImageColumn";
...
describe("VehicleImageColumn test", () => {
  it("should render VehicleImageColumn", () => {
              renderWithReduxAndRouter(
                <VehicleImageColumn vehicle={vehicleData} />
              );
  ...
  it("should redirect to vehicle details page", () => {
    renderWithReduxAndRouter(<VehicleImageColumn vehicle={vehicleData} />);
    const detailsRedirect = screen.getByTestId("img-button");
    fireEvent.click(detailsRedirect);
    // expect(screen.getAllByText(/honda/i));
  });
});
