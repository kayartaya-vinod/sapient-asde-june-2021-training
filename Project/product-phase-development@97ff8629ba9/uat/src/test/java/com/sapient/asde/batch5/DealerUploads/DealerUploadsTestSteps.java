...
public class DealerUploadsTestSteps {
    ...
    public void i_navigate_to_dealer_dashboard() {
        driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);
        driver.get(baseURL + "dealer/dashboard/upload-success");
    }

    @Then("I should see a list of past uploaded files")
    public void i_should_see_a_list_of_past_uploaded_files() {
        List<WebElement> listItems = driver.findElements(By.xpath("//*[@id=\"root\"]/div[1]/div/div[1]/div[2]/div[2]/div[3]"));
